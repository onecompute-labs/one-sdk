...
### Added
- `OneClient` — OpenAI-compatible client for the ONE gateway (default `https://onecomputeai.xyz/platform/v1`).
...
- Receipt extraction from the gateway response for use with [OneVerify](https://onecomputeai.xyz/docs).
- Full TypeScript type surface and bundled declarations.
- 56 unit tests (all network mocked via injected `fetch`).

[Unreleased]: https://github.com/onecompute-labs/one-sdk/compare/v0.1.0...HEAD
[0.1.0]: https://github.com/onecompute-labs/one-sdk/releases/tag/v0.1.0
